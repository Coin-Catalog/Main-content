    ...
    <section className={styles.related}>
      <section className={`${styles.item_1} ${styles.item}`}>
        <Link
          ...
          href={`/coin/${relatedCoins[0][0]}/${relatedCoins[0][1]}`}
        >
      ...
      <section className={`${styles.item_2} ${styles.item}`}>
        <Link
          className="no_deceration"
          href={`/coin/${relatedCoins[1][0]}/${relatedCoins[1][1]}`}
        >
          <picture className={`${styles.image}`}>
            <source
              className={`${styles.image}`}
      ...
      <section className={`${styles.item_3} ${styles.item}`}>
        <Link
          className="no_deceration"
          href={`/coin/${relatedCoins[2][0]}/${relatedCoins[2][1]}`}
        >
          <picture className={`${styles.image}`}>
            <source
              className={`${styles.image}`}
      ...
      <section className={`${styles.item_4} ${styles.item}`}>
        <Link
          className="no_deceration"
          href={`/coin/${relatedCoins[3][0]}/${relatedCoins[3][1]}`}
        >
          <picture className={`${styles.image}`}>
            <source
              className={`${styles.image}`}
